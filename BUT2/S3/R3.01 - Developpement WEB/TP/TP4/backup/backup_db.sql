...
CREATE TABLE `matchs` (
  ...
  `code_equipe1` varchar(3) NOT NULL,
  `code_equipe2` varchar(3) NOT NULL,
  ...
  KEY `FK_code_pays_1` (`code_equipe1`),
  KEY `FK_code_pays_2` (`code_equipe2`),
  CONSTRAINT `FK_code_pays_1` FOREIGN KEY (`code_equipe1`) REFERENCES `equipes` (`code_pays`),
  CONSTRAINT `FK_code_pays_2` FOREIGN KEY (`code_equipe2`) REFERENCES `equipes` (`code_pays`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-11 16:44:28
