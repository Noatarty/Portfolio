...
class MatchFinale {
    private $conn;
    private $table_name = "matches_finale";
    ...
    // Créer un nouveau match de finale
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " 
                  (code_equipe_1, code_equipe_2, date_match, score_equipe_1, score_equipe_2) 
                  VALUES (:code_equipe_1, :code_equipe_2, :date_match, :score_equipe_1, :score_equipe_2)";
